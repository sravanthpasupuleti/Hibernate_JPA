...
public class Owner {
	...
	public String toString() {
		return "OwnerDTO [id=" + compositePrimaryKey.getId() + ", firstName=" + firstName + ", lastName=" + lastName + ", gender=" + gender
				+ ", city=" + city + ", state=" + state + ", mobileNumber=" + mobileNumber + ", emailId=" + emailId
				+ ", petId=" + compositePrimaryKey.getPetId() + ", petName=" + petName + ", petBirthDate=" + petBirthDate + ", petGender="
